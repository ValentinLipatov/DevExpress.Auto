...
namespace XML
{
    public abstract class BaseForm : XtraForm
    {
...
#if DEBUG
        protected string WorkspaceFileName => $"..\\..\\..\\Workspaces\\{Name}.{GetType().Name}.xml";
#else
        private string WorkspaceFileName => $"Workspaces\\{Name}.{GetType().Name}.xml";
#endif
        ...
        {
            return (T)GetLayout<LayoutControlItem>(name)?.Control;
        }
